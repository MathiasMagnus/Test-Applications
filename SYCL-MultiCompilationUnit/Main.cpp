// SYCL-MultiCompilationUnit include
#include <Other.hpp>
...
namespace kernels { class SYCL_MultiCompilationUnit; }
...
int main()
{
    ...
    try
    {
        ...
        queue.submit([&](cl::sycl::handler& cgh)
        {
            ...
            cgh.parallel_for<kernels::SYCL_MultiCompilationUnit>(v.get_range(), [=](cl::sycl::item<1> i)
            {
                v[i] += adder(1.f, 2.f);
            });
        });
